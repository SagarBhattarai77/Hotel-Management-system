...
if($_POST['submit'])
{
	...
	$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,firstName,middleName,lastName,gender,contactno,emailid,guardianName,guardianContactno,corresAddress) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	$stmt = $mysqli->prepare($query);
	$rc=$stmt->bind_param('iiiisissssissis',
							$roomno,
							$seater,
							$feespm,
							$foodstatus,
